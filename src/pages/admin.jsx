  ...
  return (
    <Flex height="100vh" bgColor="white">
      ...
      <Flex width="100%" paddingLeft={4} paddingRight={[5,10]} justifyContent="space-between" alignItems="center">
        ...
        <Stack bgColor="#439298" width="100%" direction="row" justifyContent={["space-around","center"]} spacing={[0, 70]} paddingTop={10} paddingBottom={10} position={["absolute","relative"]} bottom={0}>
          <Link href="/"> 
